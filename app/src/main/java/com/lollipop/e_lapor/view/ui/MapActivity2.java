...
public class MapActivity2 extends AppCompatActivity implements PermissionsListener, OnMapReadyCallback{
    ...
    public void onMapReady(@NonNull final MapboxMap mapboxMap) {
        MapActivity2.this.mapboxMap = mapboxMap;
...
// swap out for your own marker image, just make sure it matches up with the dropped marker.
            hoveringMarker = new ImageView(MapActivity2.this);
...
// Transform the appearance of the button to become the cancel button
                        selectLocationButton.setBackgroundColor(
                                ContextCompat.getColor(MapActivity2.this, R.color.blue_200));
...
// Show the SymbolLayer icon to represent the selected map location
                        ...
                        returnIntent.putExtra("lng", Double.toString(Math.floor(mapTargetLatLng.getLongitude()*10000+0.5)/10000));
                        returnIntent.putExtra("lat",Double.toString(Math.floor(mapTargetLatLng.getLatitude()*10000+0.5)/10000));
...
// Switch the button appearance back to select a location.
                        selectLocationButton.setBackgroundColor(
                                ContextCompat.getColor(MapActivity2.this, R.color.blue_500));
